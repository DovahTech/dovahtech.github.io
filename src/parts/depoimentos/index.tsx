...
export default function Depoimentos(){
  const testimonials = [
    {
      name: "Kellen Bermejo",
      role: `Nutricionista - Prefeitura Municipal Campos Novos Paulista`,
      image: "",
      text: "O serviço prestado foi excelente, todo o atendimento foi com muita atenção \r Tudo que foi solicitado, foi feito prontamente, todas as mudanças! Recomendo muito!"
    },
    // {
    //   name: "Maria Santos",
  ...
  return(
    <Section
      ...
      title="depoiments"
    >
      <h1 className="text-center md:text-6xl text-4xl mb-12 font-bold">Depoimentos</h1>
